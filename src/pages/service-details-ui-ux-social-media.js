...
const ServiceDetailsUiUxSocialMedia = () => {
    return (
        <React.Fragment>  
            <TopHeader />
            <PageBanner 
                bgText="UI/UX & Social Media" 
                pageTitle="UI/UX & Social Media" 
                homePageUrl="/" 
                homePageText="Home" 
                activePageText="UI/UX & Social Media" 
            /> 
...
export default ServiceDetailsUiUxSocialMedia